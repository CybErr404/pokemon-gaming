//60, there's a catch, in order to take a turn you needed to have a basic pokemon card in your hand.
...
public class PokemonCardGame {
    ...
    //Method that accepts parameter of how many Pokemon user wants in deck.
